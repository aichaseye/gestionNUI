...
class MatiereResourceIT {
    ...
    void createMatiere() throws Exception {
        ...
        assertThat(testMatiere.getEtatMatiere()).isEqualTo(DEFAULT_ETAT_MATIERE);
    ...
    void putNewMatiere() throws Exception {
        ...
        assertThat(testMatiere.getEtatMatiere()).isEqualTo(UPDATED_ETAT_MATIERE);
    ...
    void partialUpdateMatiereWithPatch() throws Exception {
        ...
        partialUpdatedMatiere.reference(UPDATED_REFERENCE).etatMatiere(UPDATED_ETAT_MATIERE);
