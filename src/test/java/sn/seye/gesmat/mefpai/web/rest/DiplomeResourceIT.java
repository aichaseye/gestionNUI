...
class DiplomeResourceIT {
    ...
    public static Diplome createEntity(EntityManager em) {
        Diplome diplome = new Diplome()
            .nom(DEFAULT_NOM)
            .matriculeDiplome(DEFAULT_MATRICULE_DIPLOME)
    ...
    public static Diplome createUpdatedEntity(EntityManager em) {
        Diplome diplome = new Diplome()
            .nom(UPDATED_NOM)
            .matriculeDiplome(UPDATED_MATRICULE_DIPLOME)
    ...
    void putNewDiplome() throws Exception {
        ...
        updatedDiplome.nom(UPDATED_NOM).matriculeDiplome(UPDATED_MATRICULE_DIPLOME).anneeObtention(UPDATED_ANNEE_OBTENTION);
    ...
    void partialUpdateDiplomeWithPatch() throws Exception {
        ...
        partialUpdatedDiplome.anneeObtention(UPDATED_ANNEE_OBTENTION);
    ...
    void fullUpdateDiplomeWithPatch() throws Exception {
        ...
        partialUpdatedDiplome.nom(UPDATED_NOM).matriculeDiplome(UPDATED_MATRICULE_DIPLOME).anneeObtention(UPDATED_ANNEE_OBTENTION);
