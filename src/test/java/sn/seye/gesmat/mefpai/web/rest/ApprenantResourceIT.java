...
class ApprenantResourceIT {
    ...
    private static final Etat DEFAULT_ETAT = Etat.TRANSFERT;
    private static final Etat UPDATED_ETAT = Etat.DESISTEMENT;
    ...
    void createApprenant() throws Exception {
        ...
        assertThat(testApprenant.getEtat()).isEqualTo(DEFAULT_ETAT);
    ...
    void putNewApprenant() throws Exception {
        ...
        assertThat(testApprenant.getEtat()).isEqualTo(UPDATED_ETAT);
