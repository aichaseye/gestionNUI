...
class InscriptionResourceIT {
    ...
    private static final LocalDate DEFAULT_ANNEE_INS = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_ANNEE_INS = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Inscription createEntity(EntityManager em) {
        Inscription inscription = new Inscription().anneeIns(DEFAULT_ANNEE_INS).numeroInscription(DEFAULT_NUMERO_INSCRIPTION);
        return inscription;
    }
    ...
    public static Inscription createUpdatedEntity(EntityManager em) {
        Inscription inscription = new Inscription().anneeIns(UPDATED_ANNEE_INS).numeroInscription(UPDATED_NUMERO_INSCRIPTION);
        return inscription;
    }
    ...
    void createInscription() throws Exception {
        ...
        assertThat(testInscription.getAnneeIns()).isEqualTo(DEFAULT_ANNEE_INS);
        assertThat(testInscription.getNumeroInscription()).isEqualTo(DEFAULT_NUMERO_INSCRIPTION);
    }
    ...
    @Test
    @Transactional
    void checkAnneeInsIsRequired() throws Exception {
        int databaseSizeBeforeTest = inscriptionRepository.findAll().size();
        // set the field null
        inscription.setAnneeIns(null);
    ...
    void checkNumeroInscriptionIsRequired() throws Exception {
        int databaseSizeBeforeTest = inscriptionRepository.findAll().size();
        // set the field null
        inscription.setNumeroInscription(null);
    ...
    void getAllInscriptions() throws Exception {
        ...
        restInscriptionMockMvc
            ...
            .andExpect(jsonPath("$.[*].anneeIns").value(hasItem(DEFAULT_ANNEE_INS.toString())))
    ...
    void getInscription() throws Exception {
        ...
        restInscriptionMockMvc
            ...
            .andExpect(jsonPath("$.anneeIns").value(DEFAULT_ANNEE_INS.toString()))
    ...
    void putNewInscription() throws Exception {
        ...
        updatedInscription.anneeIns(UPDATED_ANNEE_INS).numeroInscription(UPDATED_NUMERO_INSCRIPTION);
        ...
        Inscription testInscription = inscriptionList.get(inscriptionList.size() - 1);
        assertThat(testInscription.getAnneeIns()).isEqualTo(UPDATED_ANNEE_INS);
        assertThat(testInscription.getNumeroInscription()).isEqualTo(UPDATED_NUMERO_INSCRIPTION);
    }
    ...
    void partialUpdateInscriptionWithPatch() throws Exception {
        ...
        partialUpdatedInscription.anneeIns(UPDATED_ANNEE_INS);
    ...
    void fullUpdateInscriptionWithPatch() throws Exception {
        ...
        partialUpdatedInscription.anneeIns(UPDATED_ANNEE_INS).numeroInscription(UPDATED_NUMERO_INSCRIPTION);
