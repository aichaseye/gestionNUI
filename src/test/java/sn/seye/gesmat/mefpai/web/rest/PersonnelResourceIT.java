...
import sn.seye.gesmat.mefpai.domain.enumeration.Responsabilite;
...
class PersonnelResourceIT {
    ...
    void createPersonnel() throws Exception {
        ...
        assertThat(testPersonnel.getResponsabilite()).isEqualTo(DEFAULT_RESPONSABILITE);
    ...
    void putNewPersonnel() throws Exception {
        ...
        assertThat(testPersonnel.getResponsabilite()).isEqualTo(UPDATED_RESPONSABILITE);
    ...
    void partialUpdatePersonnelWithPatch() throws Exception {
        ...
        partialUpdatedPersonnel.prenomPers(UPDATED_PRENOM_PERS).responsabilite(UPDATED_RESPONSABILITE);
