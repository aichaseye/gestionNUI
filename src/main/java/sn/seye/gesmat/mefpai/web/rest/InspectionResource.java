...
public class InspectionResource {
    ...
    public ResponseEntity<List<Inspection>> getAllInspections(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Inspections");
        Page<Inspection> page = inspectionService.findAll(pageable);
