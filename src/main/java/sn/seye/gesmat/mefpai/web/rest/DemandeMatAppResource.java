...
public class DemandeMatAppResource {
    ...
    public ResponseEntity<DemandeMatApp> createDemandeMatApp(@Valid @RequestBody DemandeMatApp demandeMatApp) throws URISyntaxException {
    ...
    public ResponseEntity<DemandeMatApp> updateDemandeMatApp(
        ...
        @Valid @RequestBody DemandeMatApp demandeMatApp
    ...
    public ResponseEntity<DemandeMatApp> partialUpdateDemandeMatApp(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody DemandeMatApp demandeMatApp
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<DemandeMatApp>> getAllDemandeMatApps(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable,
        @RequestParam(required = false, defaultValue = "true") boolean eagerload
    ) {
        log.debug("REST request to get a page of DemandeMatApps");
        Page<DemandeMatApp> page;
        if (eagerload) {
            page = demandeMatAppService.findAllWithEagerRelationships(pageable);
        } else {
            page = demandeMatAppService.findAll(pageable);
        }
