...
public class DemandeMatEtabResource {
    ...
    public ResponseEntity<DemandeMatEtab> createDemandeMatEtab(@Valid @RequestBody DemandeMatEtab demandeMatEtab)
    ...
    public ResponseEntity<DemandeMatEtab> updateDemandeMatEtab(
        ...
        @Valid @RequestBody DemandeMatEtab demandeMatEtab
    ) throws URISyntaxException {
    ...
    public ResponseEntity<DemandeMatEtab> partialUpdateDemandeMatEtab(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody DemandeMatEtab demandeMatEtab
    ) throws URISyntaxException {
