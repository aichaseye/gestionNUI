...
export class DemandeMatEtabService {
  ...
  protected convertDateFromClient(demandeMatEtab: IDemandeMatEtab): IDemandeMatEtab {
    return Object.assign({}, demandeMatEtab, {
      anneeDemande: demandeMatEtab.anneeDemande?.isValid() ? demandeMatEtab.anneeDemande.format(DATE_FORMAT) : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((demandeMatEtab: IDemandeMatEtab) => {
        demandeMatEtab.anneeDemande = demandeMatEtab.anneeDemande ? dayjs(demandeMatEtab.anneeDemande) : undefined;
      });
    }
    return res;
  }
