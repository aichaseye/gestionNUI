...
To build the final jar and optimize the db_gestion_Matricule4 application for production, run:
...
Then navigate to [http://localhost:8384](http://localhost:8384) in your browser.
